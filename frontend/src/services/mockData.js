...
export const mockBooks = [
  {
    id: '1', titulo: 'Clean Code', autor: 'Robert C. Martin', isbn: '978-0132350884', preco: 89.90, desconto: 10, estoque: { quantidadeTotal: 50, quantidadeDisponivel: 50, quantidadeBloqueada: 0 },
  ...
  {
    id: '2', titulo: 'Design Patterns', autor: 'Gang of Four', isbn: '978-0201633610', preco: 79.90, desconto: 5, estoque: { quantidadeTotal: 40, quantidadeDisponivel: 40, quantidadeBloqueada: 0 },
  ...
  {
    id: '3', titulo: 'JavaScript: The Good Parts', autor: 'Douglas Crockford', isbn: '978-0596517748', preco: 69.90, desconto: 0, estoque: { quantidadeTotal: 60, quantidadeDisponivel: 60, quantidadeBloqueada: 0 },
  ...
  {
    id: '4', titulo: 'Refactoring', autor: 'Martin Fowler', isbn: '978-0201485677', preco: 99.90, desconto: 15, estoque: { quantidadeTotal: 35, quantidadeDisponivel: 35, quantidadeBloqueada: 0 },
  ...
  {
    id: '5', titulo: 'The Pragmatic Programmer', autor: 'Hunt & Thomas', isbn: '978-0201616224', preco: 85.90, desconto: 8, estoque: { quantidadeTotal: 50, quantidadeDisponivel: 50, quantidadeBloqueada: 0 },
  ...
  {
    id: '6', titulo: 'Introduction to Algorithms', autor: 'Cormen & Leiserson', isbn: '978-0262033848', preco: 129.90, desconto: 12, estoque: { quantidadeTotal: 30, quantidadeDisponivel: 30, quantidadeBloqueada: 0 },
  ...
  {
    id: '7', titulo: 'Code Complete', autor: 'Steve McConnell', isbn: '978-0735619678', preco: 95.90, desconto: 7, estoque: { quantidadeTotal: 45, quantidadeDisponivel: 45, quantidadeBloqueada: 0 },
  ...
  {
    id: '8', titulo: 'The C Programming Language', autor: 'Kernighan & Ritchie', isbn: '978-0131103627', preco: 75.90, desconto: 0, estoque: { quantidadeTotal: 55, quantidadeDisponivel: 55, quantidadeBloqueada: 0 },
  ...
  {
    id: '9', titulo: 'Learning Python', autor: 'Mark Lutz', isbn: '978-1449355739', preco: 99.90, desconto: 10, estoque: { quantidadeTotal: 60, quantidadeDisponivel: 60, quantidadeBloqueada: 0 },
  ...
  {
    id: '10', titulo: 'Data Structures and Algorithms', autor: 'Narasimha Karumanchi', isbn: '978-8173668623', preco: 74.90, desconto: 5, estoque: { quantidadeTotal: 50, quantidadeDisponivel: 50, quantidadeBloqueada: 0 },
  ...
  {
    id: '11', titulo: 'System Design Interview', autor: 'Alex Xu', isbn: '978-1736049495', preco: 89.90, desconto: 12, estoque: { quantidadeTotal: 40, quantidadeDisponivel: 40, quantidadeBloqueada: 0 },
  ...
  {
    id: '12', titulo: 'Web Development with Node.js', autor: 'Kyle Simpson', isbn: '978-1491954621', preco: 84.90, desconto: 15, estoque: { quantidadeTotal: 50, quantidadeDisponivel: 50, quantidadeBloqueada: 0 },
  ...
  {
    id: '13', titulo: 'Database Design Guide', autor: 'C.J. Date', isbn: '978-0596523657', preco: 104.90, desconto: 8, estoque: { quantidadeTotal: 35, quantidadeDisponivel: 35, quantidadeBloqueada: 0 },
  ...
  {
    id: '14', titulo: 'Computer Architecture', autor: 'David Patterson', isbn: '978-0124077263', preco: 119.90, desconto: 10, estoque: { quantidadeTotal: 30, quantidadeDisponivel: 30, quantidadeBloqueada: 0 },
  ...
  {
    id: '15', titulo: 'Operating Systems Concepts', autor: 'Silberschatz', isbn: '978-1119456339', preco: 129.90, desconto: 6, estoque: { quantidadeTotal: 30, quantidadeDisponivel: 30, quantidadeBloqueada: 0 },
  ...
  {
    id: '16', titulo: 'Artificial Intelligence: A Modern Approach', autor: 'Russell & Norvig', isbn: '978-0134610993', preco: 139.90, desconto: 5, estoque: { quantidadeTotal: 35, quantidadeDisponivel: 35, quantidadeBloqueada: 0 },
  ...
  {
    id: '17', titulo: 'Machine Learning Basics', autor: 'Andrew Ng', isbn: '978-0262025522', preco: 94.90, desconto: 11, estoque: { quantidadeTotal: 45, quantidadeDisponivel: 45, quantidadeBloqueada: 0 },
  ...
  {
    id: '18', titulo: 'Deep Learning', autor: 'Goodfellow, Bengio & Courville', isbn: '978-0262035613', preco: 149.90, desconto: 8, estoque: { quantidadeTotal: 30, quantidadeDisponivel: 30, quantidadeBloqueada: 0 },
  ...
  {
    id: '19', titulo: 'Network Security Essentials', autor: 'William Stallings', isbn: '978-0134527147', preco: 109.90, desconto: 9, estoque: { quantidadeTotal: 40, quantidadeDisponivel: 40, quantidadeBloqueada: 0 },
  ...
  {
    id: '20', titulo: 'Software Engineering: A Practitioner\'s Approach', autor: 'Roger Pressman', isbn: '978-0078022128', preco: 114.90, desconto: 7, estoque: { quantidadeTotal: 40, quantidadeDisponivel: 40, quantidadeBloqueada: 0 },
